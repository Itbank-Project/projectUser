...
<link rel="stylesheet" href="${cpath }/resources/css/joinHeader.css" >
</head>
<body>
<!-- 헤더 파일 -->
<div>
	<div style="width: 948px; margin: 0 auto; height: 45px; display: flex; align-content: center; justify-content: space-between; margin-bottom: 10px; border-bottom: 1px solid #dadada">
